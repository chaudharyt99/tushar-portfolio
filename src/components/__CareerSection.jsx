          ...
          <div className='space-y-12'>
            {experiences.map((exp, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute z-10 w-16 h-16 rounded-2xl bg-card border-2 border-primary/40 flex items-center justify-center shadow-lg ${
                      isLeft
                        ? 'md:right-[calc(50%-2rem)] left-0'
                        : 'md:left-[calc(50%-2rem)] left-0'
                    }`}
                  >
